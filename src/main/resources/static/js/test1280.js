...
$(function () {
    ...
    if (canvas.toDataURL) {
        ...
        saveCB = function (data) {
            ...
            if (pos >= 4 * w * h) {
                ...
                $.post("/main/testTestWebCam?t=" + new Date().getTime(), {
                    type: "pixel",
        ...
        saveCB = function (data) {
            ...
            pos += 4 * w;
            if (pos >= 4 * w * h) {
                $.post("/main/testTestWebCam?", {type: "pixel", image: image.join('|')}, function (data) {
                    if (data != null && data.result) {
                        console.log("====" + data);
                        pos = 0;
                        $("#img").attr("src", data.obj.imgUrl);
    ...
    //     width: 320,
    //     height: 240,
    //     swffile: $("#jsbase").attr("src") + "jscam_canvas_only.swf",
    // });
});
